...
| **#12 — MMD detecta o que nenhuma marginal revela** (PSI 0,0041 em toda feature, MMD p = 0,001, par invertido em #1 de 55) | **O corte difícil desta rodada.** Resultado forte e o único que justifica uma ferramenta a mais. Mas exige explicar o que é uma distribuição conjunta *e* o que é um teste de permutação, e o vídeo já gasta seu orçamento de conceito novo em calibração. Vai como **uma frase** no fecho: "existe drift que só um teste multivariado vê, e está medido no repositório". Candidato número 1 se o vídeo puder passar de cinco minutos. |
